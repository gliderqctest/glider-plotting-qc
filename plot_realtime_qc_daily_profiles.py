...
def main(args):
# def main(deployments, sdir, profile_groups, test):
    sdir = args.save_dir
    test = args.test
    profile_groups = args.profile_groups
    # print(f'number of profiles to group: {profile_groups}')
...
if __name__ == '__main__':
    # deployment = 'ru30-20210226T1647'  # ru34-20220113T1949  maracoos_02-20210716T1814  ru32-20220104T1656
    # save_dir = '/Users/garzio/Documents/rucool/gliders/qartod_qc/rtplots_test'  # '/home/cool/mrs/temp/gliders'
    # profile_groups = 10
    # test = True
    # main(deployment, save_dir, profile_groups, test)
